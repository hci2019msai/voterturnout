...
function question1A2Btoggle() {
    var answer1A2B = document.getElementById("answer1A2B");
    var warning1A2B = document.getElementById("warning1A2B");
    var answer1A2A = document.getElementById("answer1A2A");
    var question1A2A3 = document.getElementById("question1A2A3");
...
function question1A2A3Atoggle() {
    var answer1A2A3A = document.getElementById("answer1A2A3A");
    var answer1A2A3B = document.getElementById("answer1A2A3B");
    var dataEntry1A2A3A = document.getElementById("dataEntry1A2A3A");
...
function question1A2A3A4Atoggle() {
    var answer1A2A3A4A = document.getElementById("answer1A2A3A4A");
    var answer1A2A3A4B = document.getElementById("answer1A2A3A4B");
    var answer1A2A3A4C = document.getElementById("answer1A2A3A4C");
    var question1A2A3A4A5 = document.getElementById("question1A2A3A4A5");
    var licenseNext = document.getElementById("licenseNext");
...
function question1A2A3A4Btoggle() {
    var answer1A2A3A4A = document.getElementById("answer1A2A3A4A");
    var answer1A2A3A4B = document.getElementById("answer1A2A3A4B");
    var answer1A2A3A4C = document.getElementById("answer1A2A3A4C");
    var question1A2A3A4A5 = document.getElementById("question1A2A3A4A5");
...
function question1A2A3A4Ctoggle() {
    var answer1A2A3A4A = document.getElementById("answer1A2A3A4A");
    var answer1A2A3A4B = document.getElementById("answer1A2A3A4B");
    var answer1A2A3A4C = document.getElementById("answer1A2A3A4C");
    var question1A2A3A4A5 = document.getElementById("question1A2A3A4A5");
